...
class GeneralPlacementRequest extends Component<Props> {
  state = {
      ...
      <div>
        <div id="request-letter">
          ...
          <div className="letter-content">
            ...
            "www.coeips.netlify.com" to register and choose the number of
...
GeneralPlacementRequest.defaultProps = {
  acadYear: constants.app.ACAD_YEAR
};

export default GeneralPlacementRequest;
