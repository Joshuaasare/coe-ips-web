...
export const selectionOptions = {
  ...
  DISTRICTS: {
    'Western Region': [
      ...
      { text: 'Nzema East', value: 12 },
      { text: 'Prestea-Huni', value: 13 },
      { text: 'Sefwi Akontombra', value: 14 },
      { text: 'Sefwi Wiawso', value: 15 },
      { text: 'Sekondi Takoradi Metropolitan', value: 16 },
      { text: 'Tarkwa-Nsuaem', value: 17 },
      { text: 'Shama', value: 18 },
      { text: 'Wassa East', value: 19 },
      { text: 'Wassa West', value: 20 },
      { text: 'Asankragua', value: 21 }
    ],
