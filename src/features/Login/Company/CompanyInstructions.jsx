 ...
 * @Last Modified time: 2020-02-04 10:32:51
 */
...
const CompanyInstructions = (props: Props) => {
    ...
    <MainContent toolbar={renderToolbar()}>
      <div className="registration">
          ...
          <div className="row">
            <div className="col-1-of-3">
              <div className="note_image-container">
                <img src={svg.eng} className="note_image" alt="" />
              </div>
            </div>
            ...
            <div className="col-2-of-3">
              <div className="registration__welcome">
                <span className="registration__welcome--main">
                  Welcome to the Company Registration Page
                </span>
        ...
        <div className="registration__instructions">
          {renderInstructions(instructions.COMPANY_REGISTRATION_INSTRUCTIONS)}
        </div>
        ...
        <div className="registration__button-container">
          <Button
            size="massive"
            color="teal"
            onClick={() => pushRoute(routes.COMPANY_REGISTRATION_FORM.path)}
          >
            Proceed
